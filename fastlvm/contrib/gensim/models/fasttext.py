...
import fastlvm.contrib.gensim.models._fasttext_bin

from fastlvm.contrib.gensim.models.word2vec import Word2VecVocab, Word2VecTrainables, train_sg_pair, train_cbow_pair
from fastlvm.contrib.gensim.models.keyedvectors import FastTextKeyedVectors
from fastlvm.contrib.gensim.models.base_any2vec import BaseWordEmbeddingsModel
from fastlvm.contrib.gensim.models.utils_any2vec import ft_ngram_hashes
...
class FastText(BaseWordEmbeddingsModel):
    ...
    def load(cls, *args, **kwargs):
        ...
        fastlvm.contrib.gensim.models.keyedvectors._try_upgrade(model.wv)
...
def _load_fasttext_format(model_file, encoding='utf-8', full_model=True):
    ...
    with utils.open(model_file, 'rb') as fin:
        m = fastlvm.contrib.gensim.models._fasttext_bin.load(fin, encoding=encoding, full_model=full_model)
