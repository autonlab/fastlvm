...
from fastlvm.contrib.gensim import utils
import logging
from timeit import default_timer
import threading
from six.moves import range
from six import itervalues, string_types
from fastlvm.contrib.gensim import matutils
    ...
    * self.trainables - internal matrices (see :class:`~gensim.models.word2vec.Word2VecTrainables` as example)
    ...
    def _train_epoch_corpusfile(self, corpus_file, cur_epoch=0, total_examples=None, total_words=None, **kwargs):
        ...
        **kwargs : object
        ...
        raise ValueError("calling _train_epoch_corpusfile.")
        from fastlvm.contrib.gensim.models.word2vec_corpusfile import CythonVocab
        from fastlvm.contrib.gensim.models.fasttext import FastText
